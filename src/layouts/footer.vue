<template>
  <div class="foot-btn" >
    <ul>
      ...
      <router-link to="/xx" tag="li" active-class="home-active" class="write"><a href="javascript:;"></a></router-link>
      <router-link to="/user" tag="li" active-class="home-active" class="my"><a href="javascript:;"></a></router-link>
